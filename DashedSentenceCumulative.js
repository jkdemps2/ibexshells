...
jqueryWidget: {
    _init: function() {
        ...
        if (typeof(this.options.s) == "string") {
            ...
            assert_is_arraylike(this.options.s, "Bad value for 's' option of DashedSentenceCumulative.");
        ...
        assert(this.mode == "self-paced reading" || this.mode == "speeded acceptability",
               "Value of 'mode' option for DashedSentenceCumulative controller must be either " +
        ...
        assert(this.display == "dashed" || this.display == "in place",
               "Value of 'display' option for DashedSentenceCumulative controller must be either " +
        ...
        assert(this.sentenceDescType == "md5" || this.sentenceDescType == "literal", "Bad value for 'sentenceDescType' option of DashedSentenceCumulative.");
